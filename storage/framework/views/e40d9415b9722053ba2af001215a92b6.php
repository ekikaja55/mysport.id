...
<head>
    ...
    <link href="<?php echo e(asset('css/admin/sidebar.css')); ?>" rel="stylesheet">
</head>
    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="<?php echo e(route('admin.home')); ?>" class="list-group-item list-group-item-action bg-dark text-white">
                ...
                <div class="collapse" id="masterDataMateriMenu">
                    <a href="<?php echo e(route('materi.view')); ?>"
                        class="list-group-item list-group-item-action bg-dark text-white ps-5">
                        <i class="fas fa-eye"></i> View Data
                    </a>
                    <a href="<?php echo e(route('materi.create')); ?>"
                        class="list-group-item list-group-item-action bg-dark text-white ps-5">
                        <i class="fas fa-plus-circle"></i> Add Data
                    </a>
                </div>
...
<?php /**PATH C:\LARAVEL\jobsheet_week11_rizkiarkant\resources\views/template/admin/sidebar.blade.php ENDPATH**/ ?>